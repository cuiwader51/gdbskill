...
The skill lives in [gdb-debugging/](gdb-debugging/) — see its
[README](gdb-debugging/README.md) for full docs, install steps, and a real end-to-end
example.
...
- `gdb-debugging/` — the skill (SKILL.md + references + scripts).
